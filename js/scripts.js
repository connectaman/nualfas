 ...
 * 
 */
Business.prototype.initBusiness = function () {
...
/**
 * Initialization Header Swiper
 * 
 */
Business.prototype.initHeaderSwiper = function () {
...
/**
 * Initialization Team Swiper
 * 
 */
Business.prototype.initTeamSwiper = function () {
 ...
 * 
 */
Business.prototype.initPositionSwiper = function () {
    var positionSlider = $("#position-slider");

    var positionswiper = new Swiper(positionSlider, {
        pagination: {
...
* 
*/
Business.prototype.initMap = function () {
    ...
    var options = {
        ...
        center: { lat: posLatitude, lng: posLatitude },
    ...
    var bounds = new google.maps.LatLngBounds(
        new google.maps.LatLng(posLatitude, posLatitude),
        new google.maps.LatLng(posLatitude, posLatitude));
    var srcImage = 'img/overlay-map.png';
    ...
    //     position: latlng,
    //     icon: '<i class="fa fa-send fa-3x" style="color:rgba(153,102,102,0.8);"></i>',
    //     map: map,
    //       labelContent: '<i class="fa fa-send fa-3x" style="color:rgba(153,102,102,0.8);"></i>',
...
// Business.prototype.initGoogleMap = function() {
//     initMap();

// }
/**
 * Initialization Menu Business
 * 
 */
Business.prototype.initMenu = function () {
    $(".btn-menu").on((window.supportsTouch) ? "touchstart" : "click", function (event) {
        event.stopPropagation();
        $(".space-menu").fadeIn();
        $(".right-menu").toggleClass("open");
        $("body").addClass("fixed");
    });
    $(document).on((window.supportsTouch) ? "touchstart" : "click", function (event) {
        event.stopPropagation();
        if (!$(event.target).closest(".right-menu").length && $(".right-menu").hasClass("open")) {
...
/**
 * Initialization Video Popup
 * 
 */
var popup_video = $("<div />", {
    "id": "popup_video"
});
Business.prototype.initVideoPopup = function () {
    "use strict";

    $(".js-canvideo").on((window.supportsTouch) ? "touchstart" : "click", function (event) {
        event.preventDefault();
        popup_video.appendTo($("body"));

        $(this).next(".video-container").clone().appendTo(popup_video);
        popup_video.fadeIn();
        $("body").addClass("overflow");
    });

    popup_video.on((window.supportsTouch) ? "touchstart" : "click", function (event) {
        event.preventDefault();
...
/**
 * Initialization Vocation Popup
 * 
 */
Business.prototype.initVocationPopup = function () {
    var input = $(".inputfile");
    input.on('change', function (e) {
        $(".label-file").text($(this)[0].files[0].name);
    });
    ...
    $(".btn-apply").on("click", function (e) {
        event.stopPropagation();
        e.preventDefault();
        $(".wrapper-popup").addClass("open");
        $("body").addClass("fixed");

    });
    $(document).on((window.supportsTouch) ? "touchstart" : "click", function (event) {
        event.stopPropagation();
        if (!$(event.target).closest(".form-vocation").length && $(".wrapper-popup").hasClass("open")) {
            $(".wrapper-popup").removeClass("open");
            $("body").removeClass("fixed");
